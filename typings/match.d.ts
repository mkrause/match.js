...
declare const defaultCase : unique symbol;
...
export declare const match : MatchProps & (
...
export declare const matchType : MatchProps & (
...
// export declare const matchSingleKey : MatchProps & (
...
export declare const matcher : <S, B>(parseSubject : (subject : S) => { tag : Tag, body : B }) =>
    MatchProps & (
